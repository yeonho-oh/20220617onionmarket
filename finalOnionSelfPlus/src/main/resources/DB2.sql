...
VALUES(TRADING_BOARD_SEQ.nextval,'예시제목','예시내용','삽니다',1,1500,'iu.jpg',150,'java',SYSDATE);
INSERT INTO TRADING_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,BOARD_KIND,TRADE_STATUS,TRADE_PRICE,PRODUCT_PICTURE,HITS,MEMBERID,BOARD_DATE) 
VALUES(TRADING_BOARD_SEQ.nextval,'예시제목2','예시내용2','삽니다',1,1500,'SALE.png',140,'java',SYSDATE);
INSERT INTO TRADING_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,BOARD_KIND,TRADE_STATUS,TRADE_PRICE,PRODUCT_PICTURE,HITS,MEMBERID,BOARD_DATE) 
VALUES(TRADING_BOARD_SEQ.nextval,'예시제목3','예시내용3','팝니다',1,1500,'Chat.png',130,'spring',SYSDATE);
INSERT INTO TRADING_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,BOARD_KIND,TRADE_STATUS,TRADE_PRICE,PRODUCT_PICTURE,HITS,MEMBERID,BOARD_DATE) 
VALUES(TRADING_BOARD_SEQ.nextval,'예시제목4','예시내용4','삽니다',1,1500,'양파마켓.gif',120,'spring',SYSDATE);
...
VALUES('java', 36.5, 1);
INSERT INTO TEMP(MEMBERID, TEMP, TEMPCOUNT)
VALUES('spring', 36.5, 1);
INSERT INTO TEMP(MEMBERID, TEMP, TEMPCOUNT)
VALUES('kiki', 36.5, 1);
INSERT INTO TEMP(MEMBERID, TEMP, TEMPCOUNT)
VALUES('javaking', 36.5, 1);
INSERT INTO TEMP(MEMBERID, TEMP, TEMPCOUNT)
VALUES('가나다라', 36.5, 1);
INSERT INTO TEMP(MEMBERID, TEMP, TEMPCOUNT)
VALUES('아아아아아아', 36.5, 1);
INSERT INTO TEMP(MEMBERID, TEMP, TEMPCOUNT)
VALUES('아아아아아', 36.5, 1);
INSERT INTO TEMP(MEMBERID, TEMP, TEMPCOUNT)
VALUES('123', 36.5, 1);
